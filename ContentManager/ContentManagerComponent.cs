...
namespace Radyn.ContentManager
{
    public class ContentManagerComponent
    {
        ...
        public IContentContentFacade ContentContentTransactionalFacade(IConnectionHandler connectionHandler)
        {
            return new ContentContentFacade(connectionHandler);
        }

        public IPartialLoadFacade PartialLoadTransactionalFacade(IConnectionHandler connectionHandler)
        {
            return new PartialLoadFacade(connectionHandler);
        }
    }
}
