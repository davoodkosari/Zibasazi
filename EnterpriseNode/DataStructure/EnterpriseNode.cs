...
namespace Radyn.EnterpriseNode.DataStructure
{
    ...
    public sealed class EnterpriseNode : DataStructureBase<EnterpriseNode>
    {
        ...
        private Int32 _enterpriseNodeTypeId;
        [DbType("int")]
        public Int32 EnterpriseNodeTypeId
        {
            get
            {
            ...
            set
            {
                ...
                if (EnterpriseNodeType == null)
                    this.EnterpriseNodeType = new EnterpriseNodeType { Id = value };
            }
        }

        [Assosiation]
        public EnterpriseNodeType EnterpriseNodeType { get; set; }
