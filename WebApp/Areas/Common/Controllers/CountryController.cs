...
{
    public class CountryController : LocalizedController
    {
        ...
        public ActionResult Create(FormCollection collection)
        {
            ...
            try
            {
                ...
                if (Session["UpFileImage"] != null)
                {
                    file = (HttpPostedFileBase)Session["UpFileImage"];
                    Session.Remove("UpFileImage");
                }
                var list = new List<CountryIPRange>();
                if (Session["IPList"] != null)
                {
                    list = (List<CountryIPRange>)Session["IPList"];
                    Session.Remove("IPList");
                }
