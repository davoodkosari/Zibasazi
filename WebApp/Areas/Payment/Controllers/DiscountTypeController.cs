...
{
    public class DiscountTypeController : LocalizedController
    {
        [RadynAuthorize]
        ...
        public ActionResult GenerateDiscount(string model, byte section, Guid? tId = null)
        {
            ...
            Session[Constants.TransactionDiscountAttach] = new List<DiscountType>();
        ...
        {
            var discountTypes = (List<DiscountType>)Session[Constants.TransactionDiscountAttach];
        ...
        {
            var httpPostedFileBases = (List<DiscountType>)Session[Constants.TransactionDiscountAttach];
