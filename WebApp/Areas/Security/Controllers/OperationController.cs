...
{
    public class OperationController : LocalizedController
    {
        [RadynAuthorize()]
        ...
        public ActionResult Create(FormCollection collection)
        {
            ...
            try
            {
                ...
                if (Session["OprationIcon"] != null)
                {
                    fileBase = (HttpPostedFileBase)Session["OprationIcon"];
                    Session.Remove("OprationIcon");
                }
