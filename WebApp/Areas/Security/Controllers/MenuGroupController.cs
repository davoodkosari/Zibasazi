...
{
    public class MenuGroupController : LocalizedController
    {
        [RadynAuthorize()]
        ...
        public ActionResult Create(FormCollection collection)
        {
            ...
            try
            {
                ...
                if (Session["MenuGroupIcon"] != null)
                {
                    fileBase = (HttpPostedFileBase)Session["MenuGroupIcon"];
                    Session.Remove("MenuGroupIcon");
                }
