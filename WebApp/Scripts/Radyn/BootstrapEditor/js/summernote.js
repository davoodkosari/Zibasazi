...
(function (factory) {
    ...
    var defaults = {
         ...
         * @property {Boolean} options.disableselectimage
         * @property {Boolean} options.disablelink
        ...
        options: {
            ...
            disableselectimage: false,   // disable resizing editor
            disableCodeView: false,   // disable resizing editor
            disablelink: false,   // disable resizing editor
            ...
            fontNames: [
                ...
                'Tahoma', 'Times New Roman', 'Verdana', 'Yekan', 'vazir', 'Titr', 'Zar', 'B Nazanin', 'dastnevis'
            ],
            ...
            onCreateLink: function (sLinkUrl) {
                ...
                } else if (sLinkUrl.indexOf('http://') === -1 && !sLinkUrl.startsWith("/")) {
        ...
        lang: {
            'en-US': {
                ...
                image: {
                    ...
                    SelectFromFileManager: 'Select from FileManger',
                    maximumFileSize: 'Maximum file size',
                    maximumFileSizeError: 'Maximum file size exceeded.',
                    url: 'Image Url (click for Select from file Manager)',
                    remove: 'Remove Image'
                },
                link: {
                    link: 'Link',
                    ...
                    unlink: 'Unlink',
                    edit: 'Edit',
                    textToDisplay: 'Text to diplay (click for select from file manager)',
            ...
            'fa-IR': {
                font: {
                    ...
                    height: 'ارتفاع',
                    name: 'فونت',
                    strikethrough: 'از بین بردن',
                    subscript: 'زیرمجموعه',
                    superscript: 'فوق ستاره',
                    size: 'اندازه فونت'
                },
                image: {
                    image: 'تصویر',
                    insert: 'درج تصویر',
                    resizeFull: 'بزرگ نمایی',
                    resizeHalf: 'تغییر اندازه نصف',
                    resizeQuarter: 'تغییر اندازه یک چهارم',
                    floatLeft: 'شناور به سمت چپ',
                    floatRight: 'شناور راست',
                    floatNone: 'بدون شناور',
                    shapeRounded: 'شکل: گرد',
                    shapeCircle: 'شکل: دایره',
                    shapeThumbnail: 'شکل: تصویر بند انگشتی',
                    shapeNone: 'شکل: هیچ',
                    dragImageHere: 'تصویر یا متن را در اینجا بکشید',
                    dropImage: 'قطره عکس یا متن',
                    selectFromFiles: 'فایل را انتخاب کنید',
                    SelectFromFileManager: 'انخاب فابل از مدیریت فایل',
                    maximumFileSize: 'حداکثر اندازه فایل',
                    maximumFileSizeError: 'حداکثر اندازه فایل بیش از حد است.',
                    url: 'مسیر تصویر(جهت انتخاب از مدیریت فایل کلیک نمایید)',
                    remove: 'حذف مسیر'
                },
                link: {
                    link: 'لینک',
                    ...
                    unlink: 'حذف لینک',
                    edit: 'ویرایش',
                    textToDisplay: 'متن نمایشی (جهت انتخاب تصویر از مدیرت فایل کلیک نمایید)',
                    url: 'به چه مسیری این لینک باید برود؟',
                    openInNewWindow: 'بازشدن در پنجره جدید'
                },
                table: {
                    table: 'جدول'
                },
                hr: {
                    insert: 'قوانین افقی را وارد کنید'
                },
                style: {
                    style: 'سبک',
                    normal: 'Normal',
    ...
    var EventHandler = function () {
        ...
        this.attachCustomEvent = function (layoutInfo, options) {
            ...
            $editable.on(changeEventName, function () {
                $("#" + options.elementname).val($editable.html());
    ...
    var Renderer = function () {
         ...
         * @param {String} [footer='']
         */
        var tplDialog = function (className, title, body, footer, elname) {
            elname= elname != undefined ? elname : "editor";
            return '<div class="' + className + ' modal   fade " aria-hidden="false" role="dialog">' +
                '<div id="DivEditorModal_' + elname + '"></div>' +
        ...
        var tplButtonInfo = {
            ...
            picture: function (lang, options) {
                ...
                return options.disableselectimage === true ? "" : (tplIconButton(options.iconPrefix + 'fas fa-image', {
            ...
            link: function (lang, options) {
                return options.disablelink === true ? "" : (tplIconButton(options.iconPrefix + 'link', {
            ...
            codeview: function (lang, options) {
                return options.disableCodeView ? "" : (tplIconButton(options.iconPrefix + 'code', {
                    event: 'codeview',
        ...
        var tplDialogInfo = {
            image: function (lang, options) {
                ...
                var footer = '<button type="button" href="#" class="btn btn-lookup note-image-btn" >' + lang.image.insert + '</button>';


                var body = '<div class="imagebox">' +
                    '<div class="form-group row-fluid ">' +
                    '<input type="button" onclick="showFileManager();" class="btn btn-lookup "  value="' + lang.image.url + '" />' +
                    '<input  class="note-image-url form-control span12" style="margin-top:10px" type="text" id="txtimageurl" />' +
                    '</div>' +
                    ...
                    '</div>'
                    ;
                return tplDialog('note-image-dialog', lang.image.insert, body, footer, 'FileManagermodal');

            },

            link: function (lang, options) {
                var body = '<div class="form-group row-fluid">' +
                    '<input type="button" onclick="showlinkFileManager();" style="cursor: pointer;"  class="btn btn-lookup" value="' + lang.link.textToDisplay + '" />' +
                    '<input class="note-link-text form-control span12" style="margin-top:10px;" type="text" id="txtlinkformfilemanagerurl"/>' +
                    '</div>' +
                    '<div class="form-group row-fluid">' +
                ...
                var footer = '<button type="button" href="#" class="btn btn-lookup note-link-btn" >' + lang.link.insert + '</button>';
                return tplDialog('note-link-dialog', lang.link.insert, body, footer, 'linkManagermodal');
            },
        ...
        this.createLayoutByFrame = function ($holder, options) {
            ...
            var $editable = $('<div class="note-editable" contentEditable="' + isContentEditable + '"  style="background-color: #ffffff !important"></div>')
                .prependTo($editor);
            if (options.height) {
...
function showFileManager(element) {
    
    ShowModalInOtherTagWithReturnValue('/FileManager/RadynEditor/LookUpEditorFolder', 'DivEditorModal_FileManagermodal', 'txtimageurl', 'txtimageurl');



}
function showlinkFileManager(element) {
    
    ShowModalInOtherTagWithReturnValue('/FileManager/RadynEditor/LookUpEditorFolder?returnimage=true', 'DivEditorModal_linkManagermodal', 'txtlinkformfilemanagerurl', 'txtlinkformfilemanagerurl');
