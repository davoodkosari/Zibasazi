...
namespace Radyn.WebApp.AppCode.Base
{
    public class BaseControllerUtility
    {
        ...
        public static string GetPaeSizeKeyName<M>(string cutomePrefixname = null)
        {
            return GetPaeSizeKeyName(GetValidType(typeof(M)), cutomePrefixname);
        }
        ...
        public static string GetPaeSizeKeyName(Type type, string cutomePrefixname = null)
        {
            return "CustomeViewBage_" + GetTypeName(type) + (string.IsNullOrEmpty(cutomePrefixname) ? "" : "_" + cutomePrefixname) + "_PageSize";
        }
