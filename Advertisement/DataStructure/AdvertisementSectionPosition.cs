...
namespace Radyn.Advertisements.DataStructure
{
    ...
    public sealed class AdvertisementSectionPosition : DataStructureBase<AdvertisementSectionPosition>
    {
        private Int32 _id;
        [Key(true)]
        [Unique]
        ...
        public Int32 SectionId
        {
            ...
            set
            {
                ...
                if (AdvertisementSection == null)
                    this.AdvertisementSection = new AdvertisementSection { Id = value };
            }
        }

        [Assosiation(PropName = "SectionId")]
        public AdvertisementSection AdvertisementSection { get; set; }
