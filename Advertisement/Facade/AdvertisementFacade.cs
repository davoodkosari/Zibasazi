...
namespace Radyn.Advertisements.Facade
{
    internal sealed class AdvertisementFacade : AdvertisementsBaseFacade<Advertisement>, IAdvertisementFacade
    {
        ...
        protected override Advertisement FillComplex(Advertisement item)
        {
            if (item == null) return null;
            item.AdvertisementSectionPosition = new AdvertisementSectionPositionBO().Get(base.ConnectionHandler,
                item.PositionId);
            item.AdvertisementType = new AdvertisementTypeBO().Get(base.ConnectionHandler, item.TypeId);
            return item;
        }
